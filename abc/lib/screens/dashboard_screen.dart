...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Selector<StoreProvider, bool>(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: productsPerCategory.isEmpty
                        ...
                        : _CategoryChart(data: productsPerCategory),
                  ),
                ],
              ),
            ),
...
class _CategoryChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: data.entries.map((entry) => Expanded(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                height: maxValue > 0 ? (entry.value / maxValue) * 150 : 0,
